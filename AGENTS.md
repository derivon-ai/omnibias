...
- Wave-3 gated algebra + architectures (not shipped): `omnibias.core.mollifier`
  ...
  not justify; G2 leftover-recorded) plus LadderNet (02-10, **shipped**; Rodrigues reweight; G4 many-body leftover-recorded, exact-vs-FD leftover-recorded; G5 anharmonic leftover-recorded) /
  `omnibias.{torch,jax}.scan_equivariant` (02-08, **shipped**; gaussian steering,
  discrete `C_L`; G5 leftover-recorded, orbit cost leftover-recorded) / `omnibias.{torch,jax}.hierarchy` (02-07, **shipped**; 1-D offsets; G3 earned) /
