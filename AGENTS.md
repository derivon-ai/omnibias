...
- Wave-1 primitives: `omnibias.core.multipack` /
  ...
  `0` is `DISPROVED`, a fat zero is `BLOCKED` (not false). Identity
  ...
  Case A leftover over `Q` is
  `omnibias.holonomic.jacobian_n2_case_a` (`(b11,b21,b31)` origin
...
- Wave-3 gated algebra + architectures (not shipped): `omnibias.core.mollifier`
  ...
  `omnibias.core.frames` (01-06, **shipped**; `sigma'` not admissible; G1–G3 CI; G4 leftover-recorded) /
  ...
  `omnibias.struct._core.tropical` (01-08, **shipped**; reuses `logsumexp_gap_bound`; G3 jet derivatives CI; G4 path-following earned, `path_follow` wired to `AnnealSchedule`; cost vs n/D leftover-recorded) /
  ...
  not justify; G1/G3/G4/G5 earned; G2 leftover-recorded) plus LadderNet (02-10, **shipped**; Rodrigues reweight; G1–G3/G6 earned; G4 many-body leftover-recorded, exact-vs-FD leftover-recorded; G5 anharmonic leftover-recorded) /
  ...
  on by default; G4 conditioning earned vs strong collocation) / `omnibias.fields.locus` (02-12, **shipped**; G1–G3/G5/G6 earned; G4 Burgers RH
  ...
  (09-05, **shipped** / 09-24, **shipped**; TM hidden state + PCI box; G1–G4 CI; founding
  ...
  (09-10, **shipped**; Riccati time flow; G1–G4 CI; not DEQ / CNF; not bias
  ...
  (09-26, **shipped**; Ore export; G1–G4 CI; finite rational Lean only) /
  ...
  (07-18, **shipped**; force-free TG slab + Interval BKM integral +
  07-02 weak residual; G1–G5 CI; founding bias collapse, not
  temperature collapse; not Clay A/B) /
  `omnibias.pinn.certified.unforced`
  (07-19, **shipped**; continue or Halt; leftover #57; G1–G5 CI;
  founding bias collapse, not temperature collapse; not Clay A/B) /
  `omnibias.pinn.certified.forced_flat`
  (07-20, **shipped**; unforced limit of the 07-13 field is BLOCKED;
  leftover #58 `f0_not_a_corollary`; G1–G5 CI; founding bias collapse,
  not temperature collapse; not Clay A/B) /
  `omnibias.pinn.certified.unforced`
  ...
  [`docs/api/train_stack.md`](docs/api/train_stack.md),
  ...
  [`docs/api/unforced_slab.md`](docs/api/unforced_slab.md),
