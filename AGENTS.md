...
- Wave-3 gated algebra + architectures (not shipped): `omnibias.core.mollifier`
  ...
  not justify; G2 unearned) plus LadderNet (02-10; Rodrigues reweight; G4 many-body unearned, exact-vs-FD reported) /
  ...
  `omnibias.pinn.{travelling,layered,bem,transform}` (02-09/02-11/02-06/02-13; 02-09 G4 init-win unearned; 02-11 G4 inverse-design unearned; 02-06 G2 disc-accuracy unearned, single-layer cost reported) /
