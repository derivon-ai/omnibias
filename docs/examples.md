...
| [`pinn_causal_marching.py`](examples/pinn_causal_marching.py) | PyTorch | Causal time-marching smoke via `omnibias.pinn.train.march_solve` (causality / trivial-solution diagnostics); full two-family gate in `benchmarks/causal_marching.py` |
