...
G1/G2/G3/G5 are CI-gated and **earned** (published tanh-class list,
exact rational zeros, `balance_degree`, 1e-14 residual, negative
control). G4 PINN init-win (5× fewer
