...
| Holonomy transfer gap (07-04, **shipped**) | [`benchmarks/gauge_holonomy_gap.py`](https://github.com/derivon-ai/omnibias/blob/main/benchmarks/gauge_holonomy_gap.py) | holonomy trials on one fixed matrix; G1 factor measured; no YM / continuum; smoke [`gauge_holonomy_gap_smoke.json`](benchmarks/gauge_holonomy_gap_smoke.json) |
