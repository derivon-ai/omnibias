...
| Conjugate Hilbert (01-12 G1–G4; G5 leftover-recorded) | [`benchmarks/conjugate_hilbert.py`](https://github.com/derivon-ai/omnibias/blob/main/benchmarks/conjugate_hilbert.py) | line Hilbert only; G1–G4 in CI `all_passed`; G5 **leftover-recorded** (leftover #11; matched-width residual ratio `0.978`, need `10x`); not a stretch-gate clearing; **not** in CI `all_passed`; smoke [`conjugate_hilbert_smoke.json`](benchmarks/conjugate_hilbert_smoke.json) |
