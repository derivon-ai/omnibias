...
| Public CSV lynx–hare discovery | [`examples/symbolic_discovery/public_csv_discovery`](https://github.com/derivon-ai/omnibias/tree/main/examples/symbolic_discovery/public_csv_discovery) | interpolant-jet STLSQ vs FD / linear on Hudson Bay pelts; recovers LV `xy` signs on a synthetic orbit; not a new law; smoke [`public_csv_discovery_smoke.json`](benchmarks/public_csv_discovery_smoke.json) |
