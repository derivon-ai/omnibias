...
| Jet line search (03-12 G1/G2/G3/G6; G4/G5 leftover-recorded) | [`benchmarks/jet_line_search.py`](https://github.com/derivon-ai/omnibias/blob/main/benchmarks/jet_line_search.py) | jet vs closed-form orders 0..6; Lagrange remainder sound on exp; never-worse; torch/jax parity; G4 target-loss vs strong Wolfe **leftover-recorded** (leftover #47; `1.83x`, need `2x`), G5 order×depth crossover **leftover-recorded** (leftover #48), **not** in CI `all_passed`; smoke [`jet_line_search_smoke.json`](benchmarks/jet_line_search_smoke.json) |
