...
| Finite gauge report | [`benchmarks/gauge_finite_report.py`](https://github.com/derivon-ai/omnibias/blob/main/benchmarks/gauge_finite_report.py) | sealed bundle of the existing finite engines; cellwise SU(3) gap required; Wilson-character domain past the polymer cutoff; G1 measured; no YM / continuum / Clay staircase; smoke [`gauge_finite_report_smoke.json`](benchmarks/gauge_finite_report_smoke.json) |
