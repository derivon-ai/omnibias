...
| OMBU frames (01-06 G1–G3; G4 smoke-earned) | [`benchmarks/ombu_frames.py`](https://github.com/derivon-ai/omnibias/blob/main/benchmarks/ombu_frames.py) | `sigma'` not admissible; G4 denoising **not** in CI `all_passed`; smoke [`ombu_frames_smoke.json`](benchmarks/ombu_frames_smoke.json) |
