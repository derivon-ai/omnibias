...
| Pack tree (02-07 G1/G2/G4/G5; G3 recorded) | [`benchmarks/pack_tree.py`](https://github.com/derivon-ai/omnibias/blob/main/benchmarks/pack_tree.py) | 1-D offsets; `eta=0` bit-identical; G3 complexity **not** in CI `all_passed`; smoke [`pack_tree_smoke.json`](benchmarks/pack_tree_smoke.json) |
