...
| Face-Net (02-02) | [`benchmarks/arrangement_graph.py`](https://github.com/derivon-ai/omnibias/blob/main/benchmarks/arrangement_graph.py) | sampled tope subgraph; temperature collapse; cost vs `n`/`D` reported with cutoff `n<=12`, `D<=4`, **not** in CI `all_passed`; smoke [`arrangement_graph_smoke.json`](benchmarks/arrangement_graph_smoke.json) |
| BEM-Net (02-06) | [`benchmarks/bem_net.py`](https://github.com/derivon-ai/omnibias/blob/main/benchmarks/bem_net.py) | off-surface exact; BC approximated; linear constant-coeff homogeneous; smoke [`bem_net_smoke.json`](benchmarks/bem_net_smoke.json) |
...
| Equivariant scan (02-08) | [`benchmarks/equivariant_scan.py`](https://github.com/derivon-ai/omnibias/blob/main/benchmarks/equivariant_scan.py) | gaussian-family steering; discrete `C_L`, not SO(2)/SO(3); smoke [`equivariant_scan_smoke.json`](benchmarks/equivariant_scan_smoke.json) |
| Soliton tanh-method (02-09) | [`benchmarks/soliton_tanh_method.py`](https://github.com/derivon-ai/omnibias/blob/main/benchmarks/soliton_tanh_method.py) | tanh algebra, not a collapse; G4 `--full`; smoke [`soliton_tanh_method_smoke.json`](benchmarks/soliton_tanh_method_smoke.json) |
| Hermite ladder (02-10) | [`benchmarks/hermite_ladder.py`](https://github.com/derivon-ai/omnibias/blob/main/benchmarks/hermite_ladder.py) | Rodrigues reweight required; G4 FermiNet many-body unearned / `--full`; exact-ladder vs FD reported, **not** in CI `all_passed`; G5 may lose; smoke [`hermite_ladder_smoke.json`](benchmarks/hermite_ladder_smoke.json) |
| Layered transfer (02-11) | [`benchmarks/layered_transfer.py`](https://github.com/derivon-ai/omnibias/blob/main/benchmarks/layered_transfer.py) | 1-D ABCD; `continuum_claim=False`; smoke [`layered_transfer_smoke.json`](benchmarks/layered_transfer_smoke.json) |
