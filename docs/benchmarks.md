...
| Packaging homes (06-03 G1/G2; G3–G5 not CI) | [`benchmarks/theory_homes.py`](https://github.com/derivon-ai/omnibias/blob/main/benchmarks/theory_homes.py) | every spec names an existing home; allowlist empty; 42 packages; 93/93 homes; no `omnibias-arrangement`; G3–G5 not in CI `all_passed`; smoke [`theory_homes_smoke.json`](benchmarks/theory_homes_smoke.json) |
