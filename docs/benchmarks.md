...
| Jet line search (03-12 G1/G2/G3/G6; G4/G5 recorded) | [`benchmarks/jet_line_search.py`](https://github.com/derivon-ai/omnibias/blob/main/benchmarks/jet_line_search.py) | jet vs closed-form orders 0..6; Lagrange remainder sound on exp; never-worse; torch/jax parity; G4 step-count vs Wolfe and G5 crossover table recorded, **not** in CI `all_passed`; smoke [`jet_line_search_smoke.json`](benchmarks/jet_line_search_smoke.json) |
