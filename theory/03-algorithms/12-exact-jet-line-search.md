...
- **Status**: gated (G1/G2/G3/G6 CI; G4 step-count **reported** / unearned vs strong Wolfe (`1.83x`, need `2x`), not in CI `all_passed`; G5 order×depth crossover **reported**, not in CI `all_passed`)
- **Depends on**: 01-01
- **Blocks**: 03-01, 03-13
