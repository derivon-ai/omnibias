...
- **Status**: shipped (G1–G5 **earned** on `theory_homes` smoke — 42 packages, allowlist empty, 94/94 specs name a home, Wave-0 A4–A7 recorded, no failed falsifier / no `retired` row; G4 vacuous; G5 vacuous — not promoted: 2 external consumers, 389 lines < 2000; no new distribution)
