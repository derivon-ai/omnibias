...
- **Status**: gated (G1–G4 CI; G5 anisotropic-interface **unearned** / `--full`; orbit cost **reported**, not in CI `all_passed`; gaussian-family steering; discrete `C_L`, not SO(2)/SO(3))
