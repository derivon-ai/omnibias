...
- **Status**: gated (off-surface exact; BC approximated; linear constant-coeff homogeneous; G2 disc-accuracy **unearned** / `--full`; single-layer cost **reported**, not in CI `all_passed`; G3 smoke/`--full`)
