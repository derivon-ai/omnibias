...
- **Status**: shipped (`alpha -> inf` is sharpening, neither collapse; parallel interfaces only; G3 vs PartitionedField / FBPINN leftover-recorded / unearned, leftover #37 — linear stand-in; G4 hard vs penalized leftover-recorded / unearned, leftover #38 — zero-coeff soft; training stays `--full`)
