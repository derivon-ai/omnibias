...
- **Status**: gated (G1/G2/G4/G5 CI; G2 closed-form **earned** vs PRODUCT `substeps=4096`; G3 Magnus **reported** / unearned — no truncated holonomy API, not in CI `all_passed`; abelian + transverse-constant closed form; no YM / mass gap / continuum claim)
