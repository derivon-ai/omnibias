...
- **Status**: gated (1-D ABCD; `continuum_claim=False`; G1–G3/G6 CI; G4 inverse-design **unearned** / `--full`; stack cost **reported**; G5 conservation **reported**, not in CI `all_passed`)
