...
| [02-10 Hermite ladder nets](02-architectures/10-hermite-ladder-oscillator-net.md) | gated | Raw tower is not the QHO eigenbasis; Rodrigues reweight required; G4 FermiNet many-body **unearned** / `--full`; exact-ladder vs FD **reported**, not in CI `all_passed`; G5 may lose |
