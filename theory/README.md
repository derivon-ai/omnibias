...
| [02-10 Hermite ladder nets](02-architectures/10-hermite-ladder-oscillator-net.md) | gated | Raw tower is not the QHO eigenbasis; Rodrigues reweight required; G4 FermiNet many-body **leftover-recorded** (leftover #21; `--full`); exact-ladder vs FD **leftover-recorded** (leftover #45); G5 anharmonic **leftover-recorded** (leftover #26; loses to FD grid), not in CI `all_passed` |
