...
| [03-12 exact jet line search](03-algorithms/12-exact-jet-line-search.md) | gated | Certified radius + `verify=True` never-worse; G1/G2/G3/G6 CI; G4 step-count **leftover-recorded** (leftover #47; strong Wolfe, 1.83x, need 2x), G5 order×depth crossover **leftover-recorded** (leftover #48), not CI `all_passed` |
