...
| [01-07 order as frequency](01-geometry/07-order-as-frequency-spectral-design.md) | gated | `BandPlan` / `peak_frequency`; pack order is a band selector, not Littlewood-Paley completeness; G1–G2/G4 earned; G3 **leftover-recorded** (leftover #40; `0/5` Mscale hits), not in CI `all_passed` |
