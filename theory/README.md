...
| [06-03 packaging and rollout](06-program/03-packaging-and-rollout.md) | gated | G1/G2 **earned** (42 packages, allowlist empty, 93/93 specs name a home); G3–G5 not in CI `all_passed`; no new distribution |
