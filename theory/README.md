...
| [02-03 jet-KAN](02-architectures/03-jet-kan-univariate-basis.md) | gated | Edge-wise univariate bases; exactness of the model jet, not the target; KA theorem does not justify; G1/G3/G5 CI; G2 cost **leftover-recorded** (leftover #41; ~2.2x vs autodiff, need 5x), not CI `all_passed` |
