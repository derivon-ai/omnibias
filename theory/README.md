...
| [01-13 operator family](01-geometry/13-operator-family.md) | shipped | Scan of the six roles; catalog + rejects; not a seventh `op`; first spend `BiasScan(op="integral")` + 09-14 both shipped |
