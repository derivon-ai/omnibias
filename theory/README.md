...
| [02-13 linearizing transforms](02-architectures/13-linearizing-transform-layers.md) | shipped | Named Cole-Hopf / Miura / Bäcklund / Darboux; exactness to jet order N; G1 jet identity CI; G6 torch/jax parity CI; G2 n-soliton **leftover-recorded** (leftover #51); G3 Burgers **leftover-recorded** (leftover #39; no train vs direct PINN), not in CI `all_passed`; 03-11 search stays designed |
