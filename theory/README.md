...
| [01-08 tropical-log homotopy](01-geometry/08-tropical-log-homotopy.md) | gated | `omnibias.struct._core.tropical`; reuses `logsumexp_gap_bound`; G4 path-following **leftover-recorded** (leftover #32; no driver wired to `anneal_descent`); cost vs `n`/`D` **reported** (refuses `n>10` or `D>3`), not in CI `all_passed` |
