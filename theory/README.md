...
| [01-10 jet-bundle formalization](01-geometry/10-jet-bundle-formalization.md) | gated | Vocabulary / contact test, not a discovery and not a package; G1/G2 **earned** (`is_holonomic` 220/220, residual rates `~1/4` vs `~1/2`); G3 not in CI `all_passed` |
