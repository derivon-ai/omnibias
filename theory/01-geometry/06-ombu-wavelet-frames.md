...
- **Status**: shipped (G1–G3 CI; G4 denoising leftover-recorded / unearned, leftover #10 — `5/5` MSE vs n=1, `0/5` skill vs identity, not in CI `all_passed`; `sigma'` not admissible)
