...
- **Status**: shipped (G1–G4 CI; G5 campaign-artifact **leftover-recorded** / unearned, leftover #11 — matched-width ratio `0.978`, need `10x`, not in CI `all_passed`; line Hilbert only)
- **Depends on**: 01-01
