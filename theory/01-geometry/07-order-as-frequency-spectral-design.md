...
- **Status**: gated (G1–G2/G4 earned; G3 reported / unearned — `0/5` Mscale hits of the four-gap lstsq gate, not in CI `all_passed`; pack order is a band selector, not Littlewood-Paley completeness)
