...
- **Status**: gated (G1–G3 CI; G4 path-following **reported** / unearned — no driver wired to `anneal_descent`; reuses `logsumexp_gap_bound`; cost vs `n`/`D` **reported**, not in CI `all_passed`)
- **Depends on**: 01-03
