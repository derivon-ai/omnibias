...
def test_g5_op_integral_torch_jax_bit_identical() -> None:
    """01-13 first spend: op='integral' is bit-identical across twins."""
    import jax
    import jax.numpy as jnp
    from omnibias.jax.scan import bias_scan, init_bias_scan
    from omnibias.torch.scan import BiasScan
    ...
    assert worst <= 4.0, f"integral op parity worst_ulp={worst}"
