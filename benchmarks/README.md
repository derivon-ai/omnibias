...
| `convergence_ledger.py` | `docs/benchmarks/convergence_ledger_smoke.json` | Shipped 07-08: NS exponent ledger / YM polymer majorants discharge over `Q`; failing margin is `BLOCKED` and named; parent flags derived, never asserted; `mathlib_verified` stays false on the kernel path |
...
| `theory_homes.py` | `docs/benchmarks/theory_homes_smoke.json` | Shipped 06-03: G1–G5 earned (109/109 homes; Wave-0 A4–A7 recorded; G4/G5 vacuous; 389 lines, not promoted) |
