...
| `bem_net.py` | `docs/benchmarks/bem_net_smoke.json` | Gated 02-06: off-surface exact; G2 disc leftover-recorded (`--full`); G3 exterior win reported (no volume PINN); single-layer cost reported |
