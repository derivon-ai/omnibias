...
| `bem_net.py` | `docs/benchmarks/bem_net_smoke.json` | Gated 02-06: off-surface exact; G2 disc earned (`circle_dirichlet_density`); G3 exterior win leftover-recorded (no volume PINN); single-layer cost leftover-recorded (leftover #42) |
