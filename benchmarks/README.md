...
| `multi_interface_pinn.py` | `docs/benchmarks/multi_interface_pinn_smoke.json` | Wave-3 architecture 02-05: sharpening, neither collapse; G3 leftover-recorded (linear stand-in); G4 reported (zero-coeff; training `--full`) |
