...
| `scannet.py` | `docs/benchmarks/scannet_smoke.json` | Wave-3 architecture 02-01: ScanNet G1/G2/G3/G5; G3 wall/point vs named k-NN over two decades is in CI `all_passed`; G4 k-NN recorded; on-lattice equivariance |
