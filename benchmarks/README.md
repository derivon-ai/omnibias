...
| `soliton_tanh_method.py` | `docs/benchmarks/soliton_tanh_method_smoke.json` | Gated 02-09: tanh algebra; G4 init-win leftover-recorded (`--full`); algebraic cost leftover-recorded (leftover #44) |
