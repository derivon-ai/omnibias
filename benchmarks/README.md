...
| `hermite_ladder.py` | `docs/benchmarks/hermite_ladder_smoke.json` | Gated 02-10: Rodrigues reweight; G4 many-body leftover-recorded (`--full`); exact-vs-FD reported; G5 anharmonic reported |
