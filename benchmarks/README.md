...
| `ombu_frames.py` | `docs/benchmarks/ombu_frames_smoke.json` | Gated 01-06: `sigma'` not admissible; G4 denoising leftover-recorded (`5/5` MSE vs n=1, `0/5` skill vs identity), not in `all_passed` |
