...
| `holonomy_band.py` | `docs/benchmarks/holonomy_band_smoke.json` | Gated 02-14: no YM / mass-gap claim; G2 earned; G3 leftover-recorded; G4 reported (no Magnus U / no random gauge) |
