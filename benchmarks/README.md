...
| `conjugate_hilbert.py` | `docs/benchmarks/conjugate_hilbert_smoke.json` | Gated 01-12: line Hilbert; G1–G4 CI; G5 leftover-recorded (leftover #11; matched-width ratio `0.978`, need `10x`), not in `all_passed` |
