...
r"""Information-geometry bridge (torch): exponential-family Fisher-Rao metric.

Bit-identical twin of :mod:`omnibias.geometry.jax.ops.fisher`.
...
(:func:`omnibias.torch.information.glm_variance`). :func:`exponential_family_fisher_metric`
returns a :class:`~omnibias.geometry._core.manifold.MetricSpec`, after which
:func:`omnibias.geometry.torch.ops.christoffel`,
:func:`~omnibias.geometry.torch.ops.scalar_curvature`, etc. consume it unchanged.
...
from omnibias.torch.information import glm_variance
...
def exponential_family_fisher_metric(
    *, base: str = "softplus", dim: int = 2, name: str | None = None
    ...
    def g_point(eta: Tensor) -> Tensor:
        return torch.diag(glm_variance(eta, base=base))
