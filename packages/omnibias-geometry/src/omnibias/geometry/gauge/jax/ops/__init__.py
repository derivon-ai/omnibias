...
"""JAX gauge-theory operator surface."""

from __future__ import annotations

from omnibias.geometry.gauge.jax.ops.action import (
    action_density,
...
from omnibias.geometry.gauge.jax.ops.algebra import (
    bracket,
    from_matrix,
    generators,
    structure_constants,
...
from omnibias.geometry.gauge.jax.ops.connection import (
    bianchi,
    bianchi_from_arrays,
    connection_partials,
...
from omnibias.geometry.gauge.jax.ops.gauge import (
    gauge_invariance_defect,
    gauge_variation_field_strength,
    global_gauge_transform,
    infinitesimal_gauge_variation,
)
from omnibias.geometry.gauge.jax.ops.hodge import (
    dual_field_strength,
    hodge_star_flat,
    levi_civita,
    signature_diagonal,
)
from omnibias.geometry.gauge.jax.ops.nonintegrable import (
...
from omnibias.geometry.gauge.jax.ops.representation import (
    adjoint_generators,
...
from omnibias.geometry.gauge.jax.ops.topology import (
    euler_number_so2,
    first_chern_class,
    first_chern_number,
    is_quantized,
