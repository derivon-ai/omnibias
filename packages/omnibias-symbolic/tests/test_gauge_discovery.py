...
@pytest.mark.parametrize("illegal", ["abs_P", "G_p2", "rho"])
def test_ensemble_extra_on_gauge_discoverer_raises_before_stlsq(illegal: str) -> None:
    train, val, test, conns, _pts = make_yang_mills_bpst_split(seed=17, counts=(8, 4, 4))
