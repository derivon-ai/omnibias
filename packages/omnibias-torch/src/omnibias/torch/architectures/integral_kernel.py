...
"""Integral-kernel operator (torch; theory 09-14).

The kernel cell is the OMBU ``integral`` role. founding bias collapse
...
from omnibias.core import integral_kernel as core
