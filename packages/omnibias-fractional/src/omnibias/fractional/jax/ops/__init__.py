...
"""JAX fractional-derivative operator surface.
...
(from :mod:`~omnibias.fractional.jax.ops.analytic`) are the closed-form,
...
from omnibias.fractional.jax.ops.fractional import (
    caputo,
    grunwald_letnikov,
    riemann_liouville,
    spectral_fractional,
)
from omnibias.fractional.jax.ops.special import (
    lerch,
