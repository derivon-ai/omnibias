...
"""02-02 cost vs n/D is leftover-recorded; G3 vs k-NN stays out of all_passed."""
...
def test_cost_vs_n_d_is_reported_and_out_of_all_passed() -> None:
    ...
    assert int(cost["leftover_id"]) == 20
    assert int(cost["leftover_tick"]) == 57
    ...
    assert int(payload["honesty"]["cost_leftover_id"]) == 20
