...
PENALTY_FILES = (
    ...
    "packages/omnibias-core/src/omnibias/core/control_pid.py",
    "packages/omnibias-torch/src/omnibias/torch/optim_pid.py",
    "packages/omnibias-jax/src/omnibias/jax/optim_pid.py",
    "packages/omnibias-core/src/omnibias/core/control_lqr.py",
    "packages/omnibias-torch/src/omnibias/torch/optim_lqr.py",
    "packages/omnibias-jax/src/omnibias/jax/optim_lqr.py",
    "packages/omnibias-core/src/omnibias/core/control_mpc.py",
    "packages/omnibias-torch/src/omnibias/torch/optim_mpc.py",
    "packages/omnibias-jax/src/omnibias/jax/optim_mpc.py",
    ...
    "packages/omnibias-core/src/omnibias/core/pid_layer.py",
    "packages/omnibias-torch/src/omnibias/torch/plant_pid.py",
    "packages/omnibias-jax/src/omnibias/jax/plant_pid.py",
