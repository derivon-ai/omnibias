...
"""Torch electromagnetism ops (twin of :mod:`omnibias.fields.jax.ops.electromagnetism`).
...
``vector_derivative`` and the scalar :func:`dalembertian`, so the jax twin is
...
from omnibias.fields.torch.ops.conservation import dalembertian
